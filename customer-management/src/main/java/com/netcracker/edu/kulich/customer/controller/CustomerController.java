package com.netcracker.edu.kulich.customer.controller;

import com.netcracker.edu.kulich.customer.dto.CustomerDTO;
import com.netcracker.edu.kulich.customer.dto.transformator.Transformator;
import com.netcracker.edu.kulich.customer.entity.Customer;
import com.netcracker.edu.kulich.customer.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDTO> getCustomer(@PathVariable("email") String email) {
        ...
        if (customer == null) {
            ...
            throw new ControllerException("Customer with e-mail: \'" + email + "\' doesn't exist. Please, sign up, if you want to buy offers.");
        }
